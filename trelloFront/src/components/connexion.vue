<template>
  ...
  <article class="getAll" v-if="formConnect == true">
    ...
    <div class="timer">
      <div class="clock">
        <div class="heures">00</div>
        <div class="minutes">00</div>
        <div class="secondes">00</div>
      </div>
      <div class="timer-button">
        <p class="startTimer">Start</p>
        <p class="stopTimer">Stop</p>
      </div>
    </div>
  </article>
  <article class="dashboard" v-if="formConnect == true">
    ...
    <div class="button timer-button-div">
      <svg
        width="60%"
        height="60%"
        viewBox="0 0 111 43"
...
onUpdated(() => {
  ...
  let timerDiv = document.querySelector(".timer-button-div");
  let interval;
  let timerBloc = false;
  if (timerDiv) {
    timerDiv.addEventListener("click", () => {
      timerBloc = !timerBloc;
      console.log(timerBloc);
      if (timerBloc == false) {
...
.getAll {
  ...
  .contener-post {
    ...
    .post {
      ...
      position: relative;
      height: auto;
      background: linear-gradient(145deg, #15161e, #191a23);
      box-shadow: 20px 20px 60px #13141b, -20px -20px 60px #1b1c27;
      border-radius: 5px;
      display: flex;
      flex-direction: column;
      align-items: center;
...
.dashboard {
  ...
  .button {
    ...
    box-shadow: 20px 20px 38px #0c0e12, -20px -20px 38px #1a1c24;
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
    &:hover {
      cursor: pointer;
      background: #13151b;
      box-shadow: inset 20px 20px 38px #0c0e12, inset -20px -20px 38px #1a1c24;
    }
  }
}
.addPost {
...
.timer {
  ...
  .clock {
    ...
    border-radius: 50%;
    background: #171821;
    box-shadow: inset 20px 20px 60px #090a0d, inset -20px -20px 60px #252635;
    border: 5px solid #0fbcf9;
    display: flex;
    flex-direction: row;
    align-items: center;
    justify-content: space-evenly;
  ...
  .timer-button {
    ...
    p {
      ...
      box-shadow: 20px 20px 60px #0d0d12, -20px -20px 60px #212330;
      &:hover {
        background: #171821;
        box-shadow: inset 20px 20px 60px #0d0d12, inset -20px -20px 60px #212330;
        cursor: pointer;
      }
    }
  }
